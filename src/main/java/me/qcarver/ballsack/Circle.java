...
public class Circle {
    ...
    public void draw(float x, float y, float diameter) {
        //update(x,y,diameter/2);
        P.pushMatrix();
        P.translate(x-centerX, y-centerY);
        //makes them all same size
        //P.scale(diameter/radius * 0.75f);
        P.scale(0.25f);
        //TODO...try logrythmic scaling
        draw();
        P.popMatrix();
    }
    };
